...
class UrlGenerator implements UrlGeneratorInterface, ConfigurableRequirementsInterface
{
    ...
    protected function doGenerate($variables, $defaults, $requirements, $tokens, $parameters, $name, $referenceType, $hostTokens, array $requiredSchemes = array())
    {
        ...
        // the contexts layouts URL is already encoded (see Symfony\Component\HttpFoundation\Request)
    ...
    /**
     * Returns the target path as relative reference from the layouts path.
     *
     ...
     *
     * Example target paths, given a layouts path of "/a/b/c/d":
     * - "/a/b/c/d"     -> ""
     * - "/a/b/c/"      -> "./"
     * - "/a/b/"        -> "../"
     * - "/a/b/c/other" -> "other"
     * - "/a/x/y"       -> "../../x/y"
     *
     * @param string $basePath   The layouts path
    ...
    public static function getRelativePath($basePath, $targetPath)
    {
        ...
        // A reference to the same layouts directory or an empty subdirectory must be prefixed with "./".
