...
class StaticPrefixCollection
{
    ...
    public function addRoute($prefix, $route)
    {
        ...
        if ($this->prefix === $prefix) {
            // When a prefix is exactly the same as the layouts we move up the match start position.
     ...
     *
     * @return false|string A common prefix, longer than the layouts/group prefix, or false when none available
     */
