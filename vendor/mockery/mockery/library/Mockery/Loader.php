...
class Loader
{
    ...
    /**
     * Sets the layouts include path for all class files in the namespace of this class loader.
     *
    ...
    /**
     * Gets the layouts include path for all class files in the namespace of this class loader.
     *
