...
class ResourceRegistrar
{
    ...
    public function register($name, $controller, array $options = [])
    {
        ...
        // We need to extract the layouts resource from the resource name. Nested resources
        // are supported in the framework, but we need to know what name to use for a
        // place-holder on the route parameters, which should be the layouts resources.
    ...
    /**
     * Get the layouts resource URI for a given resource.
     *
    ...
    public function getResourceUri($resource)
    {
        ...
        // Once we have built the layouts URI, we'll remove the parameter holder for this
        // layouts resource name so that the individual route adders can suffix these
