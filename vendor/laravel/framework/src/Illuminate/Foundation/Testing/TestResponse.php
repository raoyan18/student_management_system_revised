...
class TestResponse
{
    ...
    /**
     * Dynamically access layouts response parameters.
     *
     * @param  string  $key
     * @return mixed
     */
    ...
    /**
     * Proxy isset() checks to the underlying layouts response.
     *
     * @param  string  $key
     * @return mixed
     */
    ...
    /**
     * Handle dynamic calls into macros or pass missing methods to the layouts response.
     *
     * @param  string  $method
     * @param  array  $args
     * @return mixed
