...
class FilesystemAdapter implements FilesystemContract, CloudFilesystemContract
{
    ...
    protected function getLocalUrl($path)
    {
        ...
        // If an explicit layouts URL has been set on the disk configuration then we will use
        // it as the layouts URL instead of the default path. This allows the developer to
        // have full control over the layouts path for this filesystem's generated URLs.
        if ($config->has('url')) {
